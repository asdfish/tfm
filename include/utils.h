...
extern int get_directories(const char* path, const char*** output, unsigned int* output_length);
extern int get_files(const char* path, const char*** output, unsigned int* output_length);
